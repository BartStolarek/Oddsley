...
class Outcome(models.Model):
    snapshot = models.ForeignKey(OddsSnapshot, on_delete=models.CASCADE, related_name='outcomes')
    name = models.CharField(max_length=100)
...
class EventResult(models.Model):
    ...
    details = models.JSONField(null=True, blank=True)  # For storing additional result details
